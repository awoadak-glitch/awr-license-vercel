...
export default {
  async fetch(request) {
    ...
    try {
      ...
      // Temporary compatibility mode for the native APK client.
      // Only the license itself is checked here. Package/cert/version/device
      // restrictions will be restored after the APK verification path is proven.
