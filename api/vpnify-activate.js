...
const APP_LINK = "vpnify://offer/9fK2mQ7xV4pL8nR3cT6zA1wB5dE0?source=awr";
...
export default {
  async fetch(request) {
    try {
      ...
      if (UNLIMITED_KEYS.has(key)) return page("تم التحقق من الكود بنجاح. اضغط فتح التطبيق لإكمال التفعيل.", true);
